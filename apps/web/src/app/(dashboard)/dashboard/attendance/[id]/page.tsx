...
import { SessionDetailClient, type Session, type StudentRecord, type ClassStudent } from './SessionDetailClient'
...
export default async function AttendanceDetailPage({
  ...
  // Fetch session with class info, records with student profiles
  ...
  // Also fetch class students to check for any missing records
  ...
  return (
    <SessionDetailClient
      ...
      isAdmin={profile.role === 'institution_admin'}
    />
  )
}
